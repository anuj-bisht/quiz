...
@section('content')
	...
	<div id="page-wrapper">
      ...
      <div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">{{__('Topic List')}}</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>  
      ...
      <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-success" href="{{ url('/') }}/admin/{{$view_name}}/create"> Create Topic</a>
            </div>
        </div>
      </div>
  ...
  {!! Form::open(['method' => 'DELETE','route' => ['topics.destroy', 1],'id'=>'deleteRow','style'=>'display:inline']) !!}
