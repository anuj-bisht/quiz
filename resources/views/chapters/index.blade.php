...
@section('content')
      ...
      <div class="row" style="margin-bottom:15px;">                    
          ...
          <div class="col-md-7 margin-tb">            
              <div class="pull-right">
                  <a class="btn btn-success" href="{{ route('chapters.create') }}"> Create {{$ctrl_name}}</a>
              </div>
          </div>
      </div> 
      ...
      <table id="tableData" class="table-responsive table table-striped table-bordered" style="font-size:12px;width:100% !important">
          ...
          <thead>
              ...
              <th><input type="checkbox" id="selectAll">
                    <label for="selectAll"></label></th>                                                                           	  <th>Chapter Name English</th>
                  <th>Chapter Name Hindi</th>
  ...
  {!! Form::open(['method' => 'DELETE','route' => ['chapters.destroy', 1],'id'=>'deleteRow','style'=>'display:inline']) !!}
  ...
  <script>
    ...
    jQuery(document).ready(function() {
          ...
          table = jQuery('#tableData').DataTable({
            ...
            title: 'Chapter List',
              exportOptions: {
                columns: [3, 4, 2, 1]//"thead th:not(.noExport)"
              },
