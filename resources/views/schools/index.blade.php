...
@section('content')
      ...
      <div class="row" style="margin-bottom:15px;">                    
          ...
          <div class="col-md-7 margin-tb">            
              <div class="pull-right">
                  <a class="btn btn-success" href="{{ route('schools.create') }}"> Create {{$ctrl_name}}</a>
              </div>
          </div>
        </div> 
  ...
  {!! Form::open(['method' => 'DELETE','route' => ['schools.destroy', 1],'id'=>'deleteRow','style'=>'display:inline']) !!}
  ...
  <script>
    ...
    jQuery(document).ready(function() {
          ...
          table = jQuery('#tableData').DataTable({
            ...
            title: 'School List',
              exportOptions: {
                columns: [1, 2, 3, 4]//"thead th:not(.noExport)"
              },
