...
@section('content')
	...
	<div id="page-wrapper">
      ...
      <div class="row" style="margin-bottom:15px;">                    
          <div class="col-md-5 margin-tb">&nbsp;</div>            
          <div class="col-md-7 margin-tb">            
              <div class="pull-right">
              <a class="btn btn-success" href="{{ route('exams.create') }}"> Create {{$ctrl_name}}</a>
              </div>
          </div>
        </div>    
  ...
  {!! Form::open(['method' => 'DELETE','route' => ['exams.destroy', 1],'id'=>'deleteRow','style'=>'display:inline']) !!}
