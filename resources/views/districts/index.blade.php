...
@section('content')
	...
	<div id="page-wrapper">
      ...
      <div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">{{__('District List')}}</h1>            
				</div>
				<!-- /.col-lg-12 -->
			</div>  
  ...
  {!! Form::open(['method' => 'DELETE','route' => ['districts.destroy', 1],'id'=>'deleteRow','style'=>'display:inline']) !!}
  ...
  <script>
    ...
    jQuery(document).ready(function() {
          ...
          table = jQuery('#tableData').DataTable({
            ...
            title: 'District List',
              exportOptions: {
                columns: [1,2,3]//"thead th:not(.noExport)"
              },
            ...
            'ajax': {
              'url': '{{ url("/") }}/admin/districts/ajaxData',
              'headers': {
            ...
            'columns': [
              ...
              },            
              {
                ...
                'className': 'col-md-3',
                'render': function(data, type, row) {
                  var buttonHtml = '<a class="btn btn-primary" href="'+url+'/admin/districts/'+row.id+'/edit">Edit</a>&nbsp;&nbsp;<a class="btn btn-danger" href="javascript:void(0);" onclick="deleteData('+row.id+')">Delete</a>';
                  return buttonHtml;
                }
              }
            ]
...
function deleteData(id){
  ...
  $.confirm({
      ...
      buttons: {
          confirm: function () {
            $('#deleteRow').attr('action', url+"/admin/districts/"+id).submit();  
          },
          cancel: function () {
              return true;
          }
