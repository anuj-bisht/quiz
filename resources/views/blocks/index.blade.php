...
@section('content')
	...
	<div id="page-wrapper">
      ...
      <div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">{{__('Block List')}}</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>  
      ...
      <div class="row" style="margin-bottom:15px;">                    
          ...
          <div class="col-md-7 margin-tb">            
              <div class="pull-right">
                  <a class="btn btn-success" href="{{ route('blocks.create') }}"> Create Block</a>
              </div>
          </div>
        </div>  
  ...
  {!! Form::open(['method' => 'DELETE','route' => ['blocks.destroy', 1],'id'=>'deleteRow','style'=>'display:inline']) !!}
  ...
  <script>
    ...
    jQuery(document).ready(function() {
          ...
          table = jQuery('#tableData').DataTable({
            ...
            {extend:'csvHtml5',
              exportOptions: {
                columns: [1, 2]//"thead th:not(.noExport)"
              },
            ...
            'columns': [
              ...
              },            
              {
                ...
                'className': 'col-md-3',
                'render': function(data, type, row) {
                  var buttonHtml = '<a class="btn btn-primary" href="'+url+'/admin/blocks/'+row.id+'/edit">Edit</a>&nbsp;&nbsp;<a class="btn btn-danger" href="javascript:void(0);" onclick="deleteData('+row.id+')">Delete</a>';
                  return buttonHtml;
                }
              }
            ]
...
function deleteData(id){
  ...
  $.confirm({
      ...
      buttons: {
          confirm: function () {
            $('#deleteRow').attr('action', url+"/admin/blocks/"+id).submit();  
          },
          cancel: function () {
              return true;
          }
