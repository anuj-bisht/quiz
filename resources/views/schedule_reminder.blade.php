			...
			<body style="margin:0px; padding:0px; font-family: Lato, sans-serif;">
				<table width="624" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
					<tr style="border-bottom: 5px solid #fd890c;">
						<td width="312" height="90" colspan="2" style="padding-left:20px;padding-right:0px;padding-top:0px; padding-bottom:0px;background:#000; -moz-border-top-left-radius: 10px; -webkit-border-top-left-radius:10px; border-top-left-radius:10px;-moz-border-top-right-radius: 10px; -webkit-border-top-right-radius:10px; border-top-right-radius:10px; text-align:left;">
                        <img src="http://livefitlife.in/wp-content/uploads/2021/01/LiveFit.gif" height="70" alt="Livefitlife" style="display:inline-block;">                        
						</td>
					</tr>
					<tr style="background:#f7f7f7;">
						<td colspan="2" style="padding-left:15px;padding-right:15px;padding-top:25px; padding-bottom:25px; font-size:14px; line-height:24px; color:#242424;">
							...
							<br><b>>Category:</b>{{$category_name}}
							<br><b>>Trainer:</b>{{$trainer_name}}
