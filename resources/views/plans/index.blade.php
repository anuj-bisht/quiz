...
@section('content')
	...
	<div id="page-wrapper">
      ...
      <div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">{{__('Plan List')}}</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>  
      ...
      <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-success" href="{{ url('/') }}/admin/plans/create"> Create New Plan</a>
            </div>
        </div>
      </div>
  ...
  <script>
    ...
    jQuery(document).ready(function() {
              ...
              },
		{
                  ...
                  'render': function(data,type,row){
                    var path = row.image;
			return '<img src="'+path+'" alt="" width="50px" height="50px">';
                  }
              },            
              {
                'data': 'Action',
                ...
                'className': 'col-md-3',
                'render': function(data, type, row) {
                  var buttonHtml = '<a class="btn btn-primary" href="'+url+'/admin/plans/'+row.id+'/edit">Edit</a>&nbsp;&nbsp;<a class="btn btn-danger" href="javascript:void(0);" onclick="deleteData('+row.id+')">Delete</a>';
                  return buttonHtml;
                }
              }
            ]
...
function deleteData(id){
  ...
  $.confirm({
      ...
      buttons: {
          confirm: function () {
            $('#deleteRow').attr('action', url+"/admin/plans/"+id).submit();  
          },
          cancel: function () {
              return true;
          }
